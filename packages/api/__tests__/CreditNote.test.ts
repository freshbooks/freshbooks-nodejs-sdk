...
describe('@freshbooks/api', () => {
    describe('CreditNote', () => {
        test('GET /accounting/account/<accountId>/credit_notes/cerdit_notes/<creditId>', async () => {
            ...
            mock.onGet(`/accounting/account/${ACCOUNT_ID}/credit_notes/credit_notes/${CREDIT_ID}`).replyOnce(200, mockResponse)
        ...
        test('GET /accounting/account/<accountId>/credit_notes/credit_notes?include[]=lines', async () => {
            ...
            mock.onGet(`/accounting/account/${ACCOUNT_ID}/credit_notes/credit_notes?${builder.build()}`).replyOnce(200, mockResponse)
        ...
        test('POST /accounting/account/<accountId>/credit_notes/credit_notes', async () => {
            ...
            mock.onPost(`/accounting/account/${ACCOUNT_ID}/credit_notes/credit_notes`, mockRequest).replyOnce(200, mockResponse)
            const credit_note = {
        ...
        test('PUT /accounting/account/<accountId>/credit_notes/credit_notes/<creditId>', async () => {
            ...
            `
            const mockRequest = buildMockRequest()
            mock.onPut(`/accounting/account/${ACCOUNT_ID}/credit_notes/credit_notes/${CREDIT_ID}`, mockRequest).replyOnce(200, mockResponse)
            const credit_note = {
                clientId: mockRequest.credit_notes.clientid,
                code: '',
                city: '',
